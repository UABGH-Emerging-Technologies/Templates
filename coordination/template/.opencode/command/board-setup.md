---
description: Bootstrap a new project's human+agent coordination — ingest plan/ + explorations/, draft the plan docs (human-reviewed), create and seed the GitHub Project board, install the cross-tool conventions
---
